...
for city in cities:
    ...
    city_df = city_df.drop(columns=['Location', 'RainToday', 'RISK_MM', 'RainTomorrow', 'Evaporation', 'Sunshine',
    ...
    # Define the output file path for each city
    ...
    # Validation message
    print(f'{city}_final.csv saved successfully.')
